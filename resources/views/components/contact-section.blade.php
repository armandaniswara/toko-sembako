<section class="contact" id="contact">
    <h2  class="fw-bold fs-1 ff-popins text-dark"><span>Kontak</span> Kami</h2>
    <p class="text-dark">Kami siap membantu Anda. Jika Anda memiliki pertanyaan seputar produk, pemesanan, atau pengiriman, silakan hubungi kami melalui informasi di bawah ini. Tim kami akan merespons secepat mungkin.
    </p>
    <div class="roq">
