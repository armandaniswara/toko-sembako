@php
    // Hitung total harga dengan menjumlahkan (harga * kuantitas) untuk setiap item di keranjang.
        ...
        <div class="d-flex p-3">
                        ...
                        @forelse ($checkouts as $checkout)
                            <tr>
                                ...
                                <td style="width: 15%;" class="fw-bold ff-popins">
                                    Rp{{ number_format($checkout->product->price , 2, ',', '.') }}</td>
                                <td style="width: 27%;">
            ...
            <div class="container bg-white rounded-3 ff-popins p-3 my-3" style="width: 30%;">
                ...
                <div class="d-flex">
                    ...
                    <p id="total-harga" class="fw-bold">Rp{{ number_format($totalPrice, 2, ',', '.') }}</p>
                </div>
                <div class="d-grid">
                    ...
                    <button class="btn-custom fw-bold ff-popins rounded-3" type="submit"
                            style="height: 5vh; width: 50vh">Bayar
                    </button>
                </div>
            </div>
        </div>
